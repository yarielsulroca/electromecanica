                        ...
                        <div class="mt-8 overflow-x-auto">
                            <div class="inline-block min-w-full py-2 align-middle">
                                <table class="w-full divide-y divide-gray-300">
									...
									<th scope="col" class="py-3 pl-4 pr-3 text-left text-xs font-semibold uppercase tracking-wide text-gray-500">Casification</th>
                                    ...
                                    @foreach ($items as $item)
										...
										<td class="whitespace-nowrap px-3 py-4 text-sm text-gray-500">{{ $item->casification }}</td>
										<td class="whitespace-nowrap px-3 py-4 text-sm text-gray-500">{{ $item->brand }}</td>
										<td class="whitespace-nowrap px-3 py-4 text-sm text-gray-500">{{ $item->description }}</td>
										<td class="whitespace-nowrap px-3 py-4 text-sm text-gray-500">{{ $item->about }}</td>
										<td class="whitespace-nowrap px-3 py-4 text-sm text-gray-500">{{ $item->service_id }}</td>
